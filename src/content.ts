...
export const siteContent = {
  ...
  letter: [
    ...
    "謝謝你總是接住我的情緒，總是理解我跟疼愛我。",
    "我們都在學習怎麼跟對方相處。學著理解彼此的習慣、情緒和想法。",
    "你說過，確認關係之後，你就是沒有想過要分開的人。",
    "你說過，如果用數學證明題來說，因為是我，你才想在一起。",
    "第一次聽到的時候，我其實內心很震撼。但不知道為什麼，我相信你真的做的到。",
    "對我來說，分開這個選擇永遠是最輕鬆的，以前的我都是選最輕鬆的。",
    "你是第一個我說:「我不想分開，想一直在一起。」的人噢!!",
    "因為你，我願意勇敢一次，為了我們的未來一起努力。",
    "所以請你好好珍惜你最漂亮最可愛的女朋友，要多多表達你的感情讓我知道",
    "你的努力我都有看見，我會好好珍惜，讓你每天都很幸福快樂哈哈",
