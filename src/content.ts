...
export const siteContent = {
  ...
  letter: [
    ...
    "所以你也是我第一個說:我不想跟你分開，想一直在一起。",
    "沒有說過是因為如果說了，就算過程很辛苦很痛苦，我還是會堅持，我其實很害怕，因為我從來都只想保護自己不想讓自己受傷。",
    "所以對我來說，分開這個選擇永遠是最輕鬆的。",
    "但因為你，我願意努力跨出第一步嘗試，跟你一起努力。",
    "未來一定還是會有忙碌、很累、意見不一樣的時候。",
    "但希望我們永遠記得當初堅定選擇彼此的那個初心。",
    "有我一起的第一個生日，未來還會幫你慶祝好多個生日。",
    "希望你身體健康，每天開心，永遠疼我哈哈。",
    "希望你不要這麼累。好好照顧自己，累的時候就跟我抱抱充電。",
    "希望你可以多跟我分享，不管是開心的、煩惱的。",
    "希望你可以做你想做的事，並且得到你想要的，因為你值得世界上最好的。",
