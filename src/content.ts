...
export const siteContent = {
  ...
  folders: [
    {
      ...
      memories: [
        { image: photo(28), alt: "April 和 JT 第一次見面的視訊畫面", caption: "認識第一天", note: "第一次見面，心裡想說這個人看起來好累😂完全沒想到，我們居然會在一起。" },
        { image: photo(40), alt: "April 和 JT 還沒交往前一起看棒球", caption: "一起看棒球", note: "你追我的時候我們好常見面，想說這個人怎麼每天約我出門，還好你那個時候沒那麼忙，不然就不會在一起了。" },
        { image: photo(27), alt: "April 和 JT 第一次吃炭燒鳥福", caption: "在一起前的幾小時", note: "吃完就在一起了，早就發現你喜歡我🤭雖然那天喝醉，但永遠記得在等車的時候，你在市民大道上突然抱我😳想想還是蠻心動的: )" },
  ...
  letter: [
    ...
    "謝謝你總是接住我的情緒，總是理解我跟疼愛我，也包容我的小任性。",
    
    "我們都在學習怎麼跟對方相處。學著理解彼此的習慣、情緒和想法。",
    ...
    "對以前的我來說，分開一直是最簡單的選擇。",
    "遇到問題的時候，我總是優先選擇那條比較輕鬆的路。",
    
    "但是，你是第一個讓我說:「我不想分開，想一直在一起。」的人。",
    "因為你，我願意勇敢一次，為了我們的未來一起努力。",
    
    "所以請好好疼愛你最漂亮最可愛的女朋友😘想辦法多一點儀式感好嗎哈😝",
    "也要多練習告訴我你有多喜歡我，我會覺得很幸福很開心🩵",
    
    "我會好好珍惜你對這段感情的努力跟付出，真的很謝謝你噢🥰。",
    "未來或許還是會有忙碌、很累、意見不一樣的時候。",
    "但只要我們永遠記得當初堅定選擇彼此的心，一切都會順利的。",
    
    "這是我幫你過的第一個生日，未來還有好多個生日要一起慶祝🥳",
    "希望你身體健康，每天開心，你的人生有我，一定會充滿幸運跟幸福✨",
    "希望你不要太累，偶爾也要休息一下，累的時候就跟我抱抱充電💗",
    "你所有的心願都一定都會實現，因為你值得世界上最好的一切。",
    
    "不論未來有什麼挑戰，相信只要一起努力，一切都會越來越順利💪🏻",
    "無論是開心的時刻，還是煩惱的時刻，我會一直支持你，陪著你。",
