...
export const siteContent = {
  ...
  letter: [
    ...
    "對以前的我來說，分開一直是一個很簡單的選擇",
    "遇到問題的時候，我總是很容易選擇那條比較輕鬆的路。",
    
    "可是，你是第一個讓我說:「我不想分開，想一直在一起。」的人。",
    "因為你，我願意勇敢一次，為了我們的未來一起努力。",
    
    "所以請好好疼愛你最漂亮最可愛的女朋友，不要這麼直男多一點儀式感好嗎哈哈",
    "要練習告訴我你在想什麼、你有多喜歡我，我會覺得很幸福很開心。",
    
    "我會好好珍惜你，你對這段感情的努力跟認真，我都有看見也很感謝。",
    "未來或許還是會有忙碌、很累、意見不一樣的時候。",
    "但只要我們永遠記得當初堅定選擇彼此的心，一切都會順利的。",
    
    "這是我們一起過的第一個生日，未來還有好多個生日要一起慶祝耶~",
    "希望你身體健康，每天開心，你的人生有我，一定會充滿幸運跟幸福哈哈。",
    "希望你不要這麼累。好好照顧自己，累的時候就跟我抱抱充電。",
    "你的心願一定都會實現，你就是值得世界上最好的。",
