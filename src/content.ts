...
export const siteContent = {
  ...
  letter: [
    "比比哥，生日快樂。",
    "33 年前的今天你出生了！在你身上，我看見了很多值得學習的地方，遇見你，讓我成為一個更好的人。",
    "謝謝你總是接住我的情緒，總是陪在我身邊。",
    "我們都在慢慢學習怎麼跟對方相處。學著理解彼此的習慣、情緒和需要，也學在意見不一樣的時候，好好說話、好好聽對方說。",
    "你說過，確認關係之後，你就是會一直繼續走下去的人。",
    "你說過，如果用數學證明題來說，因為是我，你才會想談戀愛。",
    "每次想起這些話，我都覺得很幸福。",
    "未來一定還是會有忙碌、很累、意見不一樣，覺得對方很煩的時候。",
    "我們都有不完美的地方，但我們願意為了彼此慢慢調整。",
    "只要我們都記得彼此的初心，就可以一起度過。",
    "希望你身體健康，每天開心，一直陪著我。",
