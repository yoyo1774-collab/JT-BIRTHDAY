...
export const siteContent = {
  ...
  letter: [
    ...
    "沒有時間陪我的時候，也要練習用其他方式讓我感受到：即使你很忙，你還是有想到我、在乎我，有用心在我們的感情裡。",
    "現階段我們能相處的時間不多，每一次都很珍貴。很多事情不要想「以後還有機會」，讓我們一起好好把握，在當下就盡力做到我們可以做到的。",
    "Happy girlfriend, happy life，哈哈💗",
    "生活上其他事情就交給我，我會負責創造很多的core memories。以後我們回頭看的時候，會有一大堆有趣的回憶。",
