...
export const siteContent = {
  ...
  letter: [
    ...
    "我知道比比哥現在的努力，都是為了未來的生活。我會一直支持你，累的時候就跟我抱抱充電💗",
    "你可以放心去衝刺目標。但要記得好好疼愛你最可愛的女朋友😘我是珍貴的保育類動物哈哈。",
    "比比哥有一個很重要的任務，就是要學會用我能感受到的方式，讓我即使你不在身邊，我也可以感受到你的愛跟用心。",
    "我知道有時候，你真的很累。不是你不想做，也不是你不在乎。",
    "你可能有很多話很多感覺，不知道要從哪裡開始。",
    "不用每一次都很完美，慢慢來，我一直都在，我相信你，也願意用心理解你。",
    
    "我會好好珍惜比比哥☺️💗讓你每天都很開心。",
    
    "這是我幫你過的第一個生日，未來還有好多個生日要一起慶祝🥳",
    "希望你身體健康，人生總是充滿幸運跟喜悅✨",
    "希望你每天都很幸福，偶爾放鬆一下不用很努力也沒關係，我會保護你。",
