...
export const siteContent = {
  ...
  letter: [
    ...
    "遇見你，讓我想成為一個更好的人。",
    "謝謝你總是接住我的情緒，努力理解我跟疼愛我，也包容我的小任性。",
    ...
    "聽到的時候，我其實很震撼也很感動。",
    "這是我心中理想的答案，只是我對愛情早就不再這麼簡單。",
    "不過不知道為什麼，我相信你真的做的到。",
    
    "對以前的我來說，分開一直是最簡單的選擇。",
    "遇到問題的時候，我總是優先選擇比較輕鬆的路。",
    
    "但因為你，我願意選擇可能會比較辛苦的路，",
    "因為我真的想要我們在一起。",
    
    "所以請你好好疼愛你最可愛的女朋友😘",
    "要練習多表達你內心的感受，多給我生活中的儀式感✨",
    "我會覺得很幸福很開心🩵",

    "也謝謝你對這段感情的努力與付出，我知道你那麼努力都是為了未來，",
    "我會好好珍惜，但也別忘了人生是由每個當下的感受累積起來，",
    "而不是最後我們擁有了什麼，所以我會努力幫你這個工作狂補充日常快樂感受，",
    "這部分就交給我吧😘",
