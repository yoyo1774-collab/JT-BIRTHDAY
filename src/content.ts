...
export const siteContent = {
  ...
  letter: [
    ...
    "我不用你一直陪我，比比哥可以安心衝刺實現目標。所以你要好好疼愛你最可愛的女朋友😘我是珍貴的保育類動物哈哈。",
    "比比哥要執行的任務，就是要常常表達你有多喜歡我哈哈。沒有時間陪我，也要練習用其他方法讓我感受到你的關心。",
    "我們相處的時間很少、很珍貴，所以很多事情不要想著以後再做，我們一起好好把握現在，盡力做到當下能做到的。",
