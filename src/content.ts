...
export const siteContent = {
  ...
  letter: [
    ...
    "遇見你，讓我想成為一個更好的人。",
    "謝謝你總是接住我的情緒，努力理解我、疼愛我，也包容我的小任性。",
    ...
    "我知道你現在的努力，都是為了未來，我會一直支持你。",
    "但比比哥也要練習多表達一點自己的感受，多給我一點生活裡的儀式感。",
    "小小的表達，會讓我更清楚地感受到你有多喜歡我，讓我覺得很幸福、很開心🩵",
    "至於你這個工作狂的日常快樂，就交給我吧。",
    "我會負責製造很多很多的core memories，讓我們以後回頭看的時候，有一大堆快樂回憶。",
    "所以要好好疼愛你最可愛的女朋友😘",
