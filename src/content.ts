...
export const siteContent = {
  ...
  letter: [
    ...
    "我知道比比哥現在的努力，都是為了未來的生活。我會一直支持你，陪在你身邊，累的時候就跟我抱抱充電💗",
    "你可以放心去衝刺目標。但要記得好好疼愛你最可愛的女朋友😘我是珍貴的保育類動物哈哈。",
    "比比哥有一個很重要的任務，就是要學會用我能感受到、我喜歡被愛的方式讓我知道你對我的愛跟用心。",
    "我知道有時候，你真的很累。有些事情不是你不想做，也不是你不在乎。",
    "有時候你可能有很多話很多感覺，不知道要從哪裡開始說。",
    "不用每一次都表現的很好，慢慢來，我一直都在，我相信你，也願意用心的理解你。",
    ...
    "你在我心中永遠是最棒的，只要你需要我，我都會在。你已經不是一個人了，有我在喔！",
