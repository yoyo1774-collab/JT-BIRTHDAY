...
export const siteContent = {
  ...
  letter: [
    ...
    "被堅定選擇對我來說很重要，也讓我有勇氣選擇比較辛苦的路，",
    "因為我真的很想跟你一直在一起。",
    
    "我知道你現在的所有努力，都是為了未來的生活。",
    "我會一直支持你，你累的時候我都會陪在你身邊。",
    "不要給自己太大壓力，累的時候就跟我抱抱充電💗",
    "要練習多表達你有多喜歡我，這樣我就覺得很幸福、很開心🩵",
    "我會負責創造很多core memories，讓我們以後回頭看的時候，有一大堆快樂回憶。",
    "所以你要好好疼愛你最可愛的女朋友😘我是稀有的保育類動物",
