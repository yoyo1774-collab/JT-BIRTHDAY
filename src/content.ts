...
export const siteContent = {
  ...
  letter: [
    ...
    "「被堅定地選擇」這件事，對我來說一直都很重要。",
    "也因為你，讓我有勇氣去選擇一條可能比較辛苦的路，因為我真的想跟你一直在一起。",
    "",
    
    "我知道比比哥現在所有的努力與辛苦，都是為了未來的生活。我會一直支持你，陪在你身邊，累的時候就跟我抱抱充電💗",
    "我不用你一直陪我，比比哥可以放心去衝刺、去實現自己的目標。你只要記得，要好好疼愛你最可愛的女朋友😘我是珍貴的保育類動物哈哈。",
    "比比哥還有一個很重要的任務，就是要常常讓我知道你有多喜歡我哈哈。",
    "沒有時間陪我的時候，也要慢慢練習用其他方式讓我感受到：即使你很忙，你還是有想到我、在乎我，也有把心放在我們的感情裡。",
    "因為我們能相處的時間不算多，所以每一次都很珍貴。很多事情不要想著「以後還有機會」，我們一起好好把握現在，在當下盡力做到我們能做到的。",
    "這樣我就會覺得自己是世界上最幸福的人💗Happy girlfriend, happy life，哈哈。",
    "生活上的事情就交給我吧，我會負責幫我們創造很多很多的core memories。以後我們回頭看的時候，會有一大堆快樂的回憶。",
    "我會好好珍惜比比哥的☺️💗",
    
    "這是我幫你過的第一個生日，未來還有好多個生日要一起慶祝🥳",
    "希望你身體健康，人生總是充滿幸運跟幸福，有可以面對一切的勇氣✨",
