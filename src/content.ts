...
export const siteContent = {
  ...
  letter: [
    ...
    "我知道比比哥現在的努力，都是為了未來的生活。我會陪著你，累的時候就跟我抱抱充電💗",
    "你放心去衝刺目標，但記得好好疼愛你最可愛的女朋友😘你說過很忙不代表可以不用心，我有記得噢哈哈，要說到做到嘻嘻。",
    "即使你不在身邊，希望我也可以感受到你的愛跟用心。",
    "我知道有時候，你真的很累。不是你不想做，也不是你不在乎。",
    "你有很多話很多感覺，不知道要從哪裡開始。",
    "不用每一次都很完美，慢慢來，我一直都在，我相信你，也願意用心理解你。",
    
    "我會好好珍惜比比哥☺️💗讓你每天都很開心。",
    "累的時候就休息一下，偶爾放鬆一下，不用一直很努力也沒關係，我會保護你。",
    "你已經不是一個人了，有我在喔！",
